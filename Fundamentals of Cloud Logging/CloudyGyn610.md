### 💡 Lab Link: [Fundamentals of Cloud Logging || GSP610](https://www.skills.google/focuses/10911?parent=catalog)
...
```
curl -LO https://raw.githubusercontent.com/CloudyGyn/CloudSkill/master/Fundamentals%20of%20Cloud%20Logging/CloudyGyn610.sh
chmod +x CloudyGyn610.sh
./CloudyGyn610.sh
```
